<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:58:"E:\webproject\mycms/application/index\view\user\index.html";i:1510106290;s:59:"E:\webproject\mycms/application/index\view\public\base.html";i:1510114736;}*/ ?>
<!DOCTYPE html>
<html>
 <head> 
  <meta charset="utf-8" /> 
                ...
                <tbody id="tableShowUsers">
                    ...
                    <tr>
                        ...
                        <td><?php if($users['user_name'] != 'admin'): ?>
                            ...
                            <a href="javascript:void(0);" go-url="<?php echo url('user/del',array('id'=>$users['id'])); ?>" class="table-link confirm ajax-get-user" del-user="<?php echo $users['user_name']; ?>">
                                            删除
                                        </a> <?php endif; ?>
                        </td>
                    </tr>
