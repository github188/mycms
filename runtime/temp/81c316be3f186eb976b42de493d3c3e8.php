...
<div class="invoice container-fluid">
    <form id="gtp_fail_form" name="inputs" action="<?php echo url('tool/gtpPost'); ?>">
        <div class="row">
            ...
            <div class="col-md-4">
                <button class="btn btn-success" id="gtp_fail_file">查 看</button>
            </div>
        </div>
    </form>
    <div class="row">
            ...
            <table class="table table-striped table-bordered table-hover">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <div align="center">
                                <button filename="<?php echo $list['filename']; ?>" id="scan_results" scan-url="<?php echo url('tool/scanResult'); ?>" class="btn btn-success" type="button">查看</button>
                            </div>
                        </td>
                        <td>
