<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:64:"E:\webproject\mycms/application/index\view\user\login_index.html";i:1509354808;}*/ ?>
<!DOCTYPE html>
<!-- saved from url=(0025)http://localhost/sentcms/ -->
<html>
...
<body style="">
    <div id="myCarousel" class="carousel slide">
        <div class="carousel-inner">
            <div class="item active" style="background:#223240">
                <img src="__ROOT__/public/static/images/login/top1.jpg" width="100%" alt="第一张">
            </div>
        </div>
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-md-6 col-lg-4 col">
                    <div class="media">
                        <div class="media-left">
                            <!-- <img src="__ROOT__/public/static/images/login/tab1-1.png" class="media-object" alt=""> -->
                            <i class="fa fa-linux" style="font-size:7em;"></i>
                        </div>
                ...
                <div class="col-md-6 col-lg-4 col">
                    <div class="media">
                        <div class="media-left">
                            <!-- <img src="__ROOT__/public/static/images/login/tab1-2.png" class="media-object" alt=""> -->
                            <i class="fa fa-windows" style="font-size:7em;"></i>
                        </div>
                        <div class="media-body">
                ...
                <div class="col-md-6 col-lg-4 col">
                    <div class="media">
                        <div class="media-left">
                            <img src="__ROOT__/public/static/images/login/tab1-3.png" class="media-object" alt="">
                        </div>
                        <div class="media-body">
                ...
                <div class="col-md-6 col-lg-4 col">
                    <div class="media">
                        <div class="media-left">
                            <img src="__ROOT__/public/static/images/login/tab1-4.png" class="media-object" alt="">
                        </div>
                        <div class="media-body">
                ...
                <div class="col-md-6 col-lg-4 col">
                    <div class="media">
                        ...
                        <div class="media-body">
                            <h4 class="media-heading">Was巡检</h4>
                            <p>简介。</p>
                        </div>
                    </div>
                </div>
    ...
    <footer id="footer">
        <div class="container">
            <span class="copyright-content">推荐使用谷歌/IE9以上的浏览器访问&nbsp;&nbsp;&nbsp;&nbsp;<a href="#" target="_blank" draggable="false"> 下载谷歌浏览器</a> </span>
        </div>
    </footer>
