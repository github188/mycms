...
<section class="content-header">
    <h1><a href="<?php echo url('role/index'); ?>" class="link">修改信息</a></h1>
</section>
        ...
        <div class="row from-box">
            <div class="form-group">
                ...
                <div class="col-lg-10 col-sm-10">
                    <input type="text" class="form-control" name="user_nickname" id="user_nickname" placeholder="昵称" value="<?php echo $info['user_nickname']; ?>" />
