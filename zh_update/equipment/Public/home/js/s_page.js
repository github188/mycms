jQuery(function () {
    ...
    // var url_valuses = first_url.split("?")[1];
    // if (url_valuses) {
    //     var url_valuse_arr = url_valuses.split("&");
    //     var valuse_nums = url_valuse_arr.length;
    //     if (valuse_nums < 3) {
    //         return false;
    //     }
    //     for (var i = 0; i < url_valuse_arr.length; i++) {
    //         var k_v = url_valuse_arr[i].split("=");
    //         if(k_v.length<2){
    //             return false;
    //         }
    //         var url_key = k_v[0];
    ...
    //         }
    //     }
    //     var active_li = $("#treeNav ul").find("[data-go="+xmsel+"]");
    // }
