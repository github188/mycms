...
//搜索
$("#mq_content-heading").on("click","#mq_search",function(){
    var mqtage = $("#mq_content-heading input[name=mqtage]").val();  
        if(mqtage=="part"){
            getData_part(1, 0);
        }else if(mqtage=="all"){
